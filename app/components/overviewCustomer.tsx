        ...
        <div className='flex'>
            ...
            <div className="w-[628px] h-[378px] left-[377px] top-[280px] absolute bg-white rounded-xl">
                <div className="w-[118px] h-[38px] left-[473px] top-[27px] absolute">
                    ...
                    <div className="left-[16px] top-[10px] absolute text-zinc-500 text-xs font-normal font-['Poppins']">Quarterly</div>
                    <svg className="left-[80px] top-[8px] absolute cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M6 9L12 15L18 9" stroke="#7E7E7E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
                <div className="left-[38px] top-[24px] absolute text-black text-[22px] font-semibold font-['Poppins']">Overview</div>
                <div className="left-[40px] top-[61px] absolute text-neutral-400 text-sm font-normal font-['Poppins']">Monthly Earning</div>
                <div className="left-[48px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Jan</div>
                <div className="left-[95px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Feb</div>
                <div className="left-[142px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Mar</div>
                <div className="left-[190px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Apr</div>
                <div className="left-[235px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">May</div>
                <div className="left-[283px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Jun</div>
                <div className="left-[332px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Jul</div>
                <div className="left-[374px] top-[325px] absolute text-neutral-600 text-[10px] font-bold font-['Poppins']">Aug</div>
                <div className="left-[424px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Sep</div>
                <div className="left-[472px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Oct</div>
                <div className="left-[518px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Nov</div>
                <div className="left-[565px] top-[325px] absolute text-neutral-600 text-[8px] font-medium font-['Poppins']">Dec</div>
            ...
            <div className=" bg-white rounded-xl w-[304px] h-[378px] left-[1041px] top-[280px] absolute">
                <div className="left-[38px] top-[24px] absolute text-black text-[22px] font-semibold font-['Poppins']">Customers</div>
                <div className="left-[38px] top-[61px] absolute text-neutral-400 text-sm font-normal font-['Poppins']">Customers that buy products</div>
                ...
                <div className="w-[101px] h-[54.66px] left-[102px] top-[193px] absolute text-center"><span className="text-black text-2xl font-bold font-['Poppins']">65%<br /></span><span className="text-black text-xs font-normal font-['Poppins'] leading-[13.07px]">Total New Customers</span></div>
            </div>
        </div>
    )
}
